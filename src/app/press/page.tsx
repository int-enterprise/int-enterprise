...
export const metadata = buildMetadata({
  title: "보도·기고",
  description:
    "서강대학교 기술경영전문대학원 박현규 교수 연구팀과 (주)인트의 공동연구·기고가 실린 기사 목록입니다.",
  path: "/press",
  keywords: [
    "인트 보도자료",
    "박현규 교수 기고",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        eyebrow="Press"
        title="쓴 글과 실린 기사"
        description={`보도자료 ${counts.보도자료}건 · 기고 ${counts.기고}건 · 인터뷰 ${counts.인터뷰}건. 대부분 법인명이 아니라 서강대 박현규 교수 연구팀 명의로 나갔습니다.`}
      />
      {pressItems.length > 0 ? <PressList /> : null}
      <FinalCta
        title="취재나 인터뷰 요청이신가요?"
